...
class BottlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bottle" do
    assert_difference('Bottle.count') do
      post bottles_url, params: { bottle: { restaurant_id: @bottle.restaurant_id, status: @bottle.status, user_id: @bottle.user_id } }
    end
  ...
  test "should update bottle" do
    patch bottle_url(@bottle), params: { bottle: { restaurant_id: @bottle.restaurant_id, status: @bottle.status, user_id: @bottle.user_id } }
